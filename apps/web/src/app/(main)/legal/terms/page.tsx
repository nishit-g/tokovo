...
export const metadata: Metadata = {
  ...
  description: "Terms of service for Tokovo phone-simulation creation workflows.",
};
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-12 space-y-10 font-mono text-sm leading-7 text-white/80">
          <section className="space-y-3">
            ...
            <p>
              Tokovo provides tools for programmatic phone-simulation video creation and rendering.
          ...
          <section className="space-y-3">
            ...
            <p>
              You are responsible for the accuracy of information you provide and the content you
              create, upload, or render through Tokovo.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              You retain responsibility for your scripts, media, captions, metadata, and rendered
              output. You must have all rights necessary to upload, render, and distribute your
              content.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              You may not use Tokovo to violate laws, infringe intellectual property, evade platform
              restrictions, distribute harmful material, or interfere with service operation.
            </p>
          </section>
