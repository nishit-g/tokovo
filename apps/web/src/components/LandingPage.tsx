            ...
            <header className="fixed inset-x-0 top-0 z-50 mix-blend-difference">
                <div className="flex items-center justify-between px-6 py-6 lg:px-12">
                    ...
                    <nav className="flex items-center gap-8">
                        <a href="#features" className="hidden font-mono text-xs uppercase tracking-[0.2em] text-white/60 hover:text-white transition-opacity sm:block">
                            Features
                        </a>
                        <a href="#how" className="hidden font-mono text-xs uppercase tracking-[0.2em] text-white/60 hover:text-white transition-opacity sm:block">
                            How it works
                        </a>
                        <a
                            href="#access"
      ...
      ======================================== */}
            <section className="relative min-h-screen overflow-hidden bg-ink text-cream">
                ...
                <div className="absolute inset-0 flex items-center justify-center overflow-hidden opacity-[0.02]">
                    <span className="font-serif text-[40vw] font-normal whitespace-nowrap select-none">TOKOVO</span>
                </div>
                ...
                <div className="relative grid min-h-screen lg:grid-cols-12">
                    ...
                    <div className="flex flex-col justify-end p-6 lg:col-span-7 lg:p-12 lg:pb-24">
                        ...
                        <h1 className="mt-8 font-serif text-display leading-[0.9] tracking-tight">
                            <span className={`block transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '300ms' }}>
                                Video
                            </span>
                            <span className={`block transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '400ms' }}>
                                content,
                            </span>
                            <span className={`block italic text-copper transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '500ms' }}>
                                as code.
                            </span>
                        </h1>

                        {/* Line */}
                        <div className={`mt-12 h-px w-24 bg-stone transition-all duration-1000 origin-left ${mounted ? 'scale-x-100' : 'scale-x-0'}`} style={{ transitionDelay: '600ms' }} />

                        {/* Subtext */}
                        <p className={`mt-6 max-w-md font-mono text-sm leading-relaxed text-stone transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '700ms' }}>
                            The programmatic video engine for studios and enterprises.
                            Define phones, apps, and conversations in TypeScript.
                            Render thousands of cinematic videos — without After Effects.
                        </p>

                        {/* Quick stats */}
                        <div className={`mt-12 flex gap-12 transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '800ms' }}>
                            <div>
                                <span className="font-serif text-3xl text-cream">10+</span>
                                <p className="mt-1 font-mono text-[10px] uppercase tracking-widest text-stone">Devices</p>
                            </div>
                            <div>
                                <span className="font-serif text-3xl text-cream">5</span>
                                <p className="mt-1 font-mono text-[10px] uppercase tracking-widest text-stone">App Sims</p>
                            </div>
                            <div>
                                <span className="font-serif text-3xl text-cream">4K</span>
                                <p className="mt-1 font-mono text-[10px] uppercase tracking-widest text-stone">Resolution</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-center justify-center p-6 lg:col-span-5 lg:p-12">
                        <div className={`w-full max-w-md transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '600ms' }}>
                            {/* Video container */}
                                ...
                                <div className="aspect-[9/16] overflow-hidden bg-charcoal">
                                    <div className="flex h-full items-center justify-center">
                                        <div className="text-center">
                                            ...
                                            <span className="font-mono text-xs uppercase tracking-widest text-stone">Watch Demo</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                {/* Scroll indicator */}
                <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 transition-all duration-700 ${mounted ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '1200ms' }}>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-12">
                    <div className="flex items-center gap-12">
                        ...
                        <div className="flex gap-16 overflow-hidden">
                            {['Content Studios', 'Marketing Teams', 'Agencies', 'Indie Creators', 'Enterprise'].map((name) => (
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-12">
                    <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
                        ...
                        <div className="lg:border-r lg:border-ink/10 lg:pr-16">
                            <span className="font-mono text-xs uppercase tracking-[0.2em] text-stone">The Problem</span>
                        ...
                        {/* Solution */}
                        <div>
                            <span className="font-mono text-xs uppercase tracking-[0.2em] text-copper">The Solution</span>
                            <h2 className="mt-6 font-serif text-3xl text-ink lg:text-4xl">
                    ...
                    <div className="grid gap-8 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-8">
                            <h2 className="font-serif text-headline text-ink">
                                Everything you need to <em className="text-copper">ship video</em> at production scale.
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="mt-24">
                        <div className="mx-auto max-w-4xl overflow-hidden border border-cream/10">
                            ...
                            <div className="flex items-center justify-between border-b border-cream/5 bg-charcoal px-4 py-3">
                                ...
                                <span className="font-mono text-[10px] uppercase tracking-widest text-stone/50">TypeScript</span>
                            </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-12">
                    ...
                    <div className="mt-16 grid gap-8 lg:grid-cols-3">
                        {[
                            ...
                            <div key={useCase.title} className="border border-ink/10 p-8 transition-colors hover:border-copper/30">
            ...
            <section id="access" className="bg-ink py-32 lg:py-40">
                <div className="mx-auto max-w-3xl px-6 text-center lg:px-12">
                    ...
                    <p className="mx-auto mt-6 max-w-lg font-mono text-sm text-stone leading-relaxed">
                        We're onboarding select studios and content teams to the private beta.
                        Request access and we'll be in touch within 48 hours.
                    </p>
