...
<Callout type="info">
**Automatic cinematography.** DirectorLite watches events and moves the camera. Writers focus on story, not camera positions.
</Callout>
...
**DirectorLite vs Manual Camera:** DirectorLite is automatic. For precise control, use the semantic camera system with `dsl.camera.anchorFocus()`.
</Callout>
