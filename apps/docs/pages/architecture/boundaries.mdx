...
<Callout type="info">
<strong>Strict separation.</strong> Each layer depends only on layers below it. IR is pure types with no dependencies. This enables testability and extensibility.
</Callout>
