...
See deep dives for subsystem details:

- [Device OS](/runtime/device-os) — Status bar time, battery, network, and modes
- [Keyboard](/runtime/keyboard) — Layouts, humanized typing, and IOSKeyboard rendering
- [Camera](/runtime/camera) — Zoom, pan, shake, and focus transforms
