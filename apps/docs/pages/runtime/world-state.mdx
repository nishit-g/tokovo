...
<Callout type="info">
<strong>Complete snapshot.</strong> WorldState = f(initialWorld, events, frame). Everything at a point in time: devices, conversations, camera, audio.
</Callout>
