...
<Callout type="info">
<strong>Beats are semantic units.</strong> Each beat groups related actions (messages, typing, reactions) with optional mood/intensity metadata for AI-readable stories.
</Callout>
