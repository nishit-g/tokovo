...
const INITIAL_WORLD = createInitialWorld({
    ...
    conversations: {
        chat_gan: {
            ...
            messages: [
                { id: "m1", from: "Kasturba ❤️", text: "Fasting again today?", type: "text", status: "read", timestamp: 1000 }
            ],
            typing: {}
        }
    },
...
const EVENTS: TimelineEvent[] = [
    ...
    // Beat 4: Send
    dsl.messages.send(180, "chat_gan", "Not today! Taco Tuesday. 🌮", "app_whatsapp"),
    dsl.keyboard.hide(185, "phone"),
    dsl.keyboard.clear(185, "phone"),

    // Beat 5: She replies
    dsl.messages.typingStart(220, "phone", "Kasturba ❤️", "app_whatsapp"),
    dsl.camera.reset(220), // Reset to see full chat

    dsl.messages.typingEnd(280, "phone", "Kasturba ❤️", "app_whatsapp"),
    dsl.messages.receive(280, "chat_gan", "Kasturba ❤️", "Spicy or mild?", "app_whatsapp"),

    // Beat 6: The punchline
    dsl.keyboard.show(310, "phone"),
    ...dsl.keyboard.type(320, "phone", "Non-violent spice pls 🥣", { speed: "fast" }),
    dsl.messages.send(400, "chat_gan", "Non-violent spice pls 🥣", "app_whatsapp"),
