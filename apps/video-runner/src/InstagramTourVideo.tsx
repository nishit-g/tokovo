...
import { instagramTourEpisode } from "@tokovo/episodes";
...
export const InstagramTourVideo: React.FC = () => {
    ...
    // Replay
    const world = replay(instagramTourEpisode.initialWorld as unknown as WorldState, instagramTourEpisode.events as any, t);
