  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div
            style={{
              ...
              backgroundImage: thread.participant.avatar
        ...
        {/* Right: Actions */}
        <div
          style={{ display: "flex", gap: 16, color: theme.colors.textPrimary }}
        >
          <PhoneIcon />
          <VideoIcon />
        </div>
      ...
      <div
        style={{
          ...
          backgroundColor: isMe
            ? theme.colors.dmBubbleOutgoing
            : theme.colors.dmBubbleIncoming,
          color: isMe
            ? theme.colors.dmTextOutgoing
            : theme.colors.dmTextIncoming,
          fontSize: 14,
          lineHeight: 1.4,
        }}
      >
