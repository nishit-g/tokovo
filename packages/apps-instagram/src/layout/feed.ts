...
export function computeInstagramFeedLayout(ctx: LayoutContext): FeedLayoutState {
  ...
  if (screen === "home") {
    ...
    regions.stories_tray = {
      id: "stories_tray",
      rect: rect(0, headerH, w, storyH),
      tags: ["stories", "tray"],
    };
    regions.feed_list = {
      id: "feed_list",
      rect: rect(0, headerH + storyH, w, Math.max(0, feedH - storyH)),
      tags: ["feed", "scroll"],
    };
    regions.feed_post_0 = {
      id: "feed_post_0",
      rect: rect(0, headerH + storyH + px(12), w, px(472)),
      tags: ["feed", "post"],
    };
    regions.feed_post_0_media = {
      id: "feed_post_0_media",
      rect: rect(0, headerH + storyH + px(58), w, px(393)),
      tags: ["feed", "post", "media"],
    };
    regions.feed_post_0_actions = {
      id: "feed_post_0_actions",
      rect: rect(screenPad, headerH + storyH + px(458), w - screenPad * 2, px(32)),
