...
function expectRegions(
  layout: { semantic?: { regions?: Record<string, unknown> } },
  ids: string[],
) {
...
describe("instagram semantic subjects", () => {
  it("home feed exposes feed subjects", () => {
  ...
  it("story viewer exposes immersive subjects", () => {
  ...
  it("thread exposes composer subjects", () => {
