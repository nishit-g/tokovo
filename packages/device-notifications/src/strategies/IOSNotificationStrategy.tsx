...
export const IOSNotificationStrategy: React.FC<NotificationStrategyProps> = ({
  notification,
}) => {
    ...
    >
      ...
      <div style={{ width: "100%" }}>
        {CustomView ? (
          ...
          (() => {
            const isMessage =
              notification.category === "message" || !!notification.icon;
                ...
                >
                  ...
                  >
                    {isEmoji ? (
                      ...
                      <span
                        style={{ color: "#999", fontSize: 16, fontWeight: 600 }}
                      >
            ...
            return (
              <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                <div style={{ fontSize: 15, opacity: 0.9, lineHeight: 1.25 }}>
                  {notification.body}
                </div>
              </div>
            );
