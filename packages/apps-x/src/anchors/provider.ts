...
export const XAnchorProvider: AnchorProvider = {
  ...
  getAnchors(
    ...
    if (screen === "timeline") {
      ...
      anchors.timeline_primary_avatar ??= { x: width * 0.04, y: height * 0.21, width: width * 0.1, height: width * 0.1 };
      ...
      anchors.timeline_primary_actions ??= { x: width * 0.16, y: height * 0.46, width: width * 0.76, height: height * 0.06 };
    ...
    if (screen === "tweet") {
      ...
      anchors.tweet_detail_header ??= { x: width * 0.03, y: height * 0.18, width: width * 0.94, height: height * 0.06 };
      anchors.tweet_detail_body ??= { x: width * 0.03, y: height * 0.24, width: width * 0.94, height: height * 0.12 };
      anchors.tweet_detail_media ??= { x: width * 0.03, y: height * 0.34, width: width * 0.94, height: height * 0.14 };
      anchors.metrics_row ??= { x: width * 0.08, y: height * 0.54, width: width * 0.84, height: height * 0.08 };
      anchors.tweet_detail_quote ??= { x: width * 0.03, y: height * 0.52, width: width * 0.94, height: height * 0.1 };
      anchors.reply_composer ??= { x: 0, y: height * 0.74, width, height: height * 0.16 };
      anchors.reply_input ??= { x: width * 0.05, y: height * 0.78, width: width * 0.72, height: height * 0.05 };
      anchors.reply_send_button ??= { x: width * 0.8, y: height * 0.78, width: width * 0.15, height: height * 0.05 };
    }

    if (screen === "compose") {
      anchors.compose_header ??= { x: 0, y: 0, width, height: height * 0.12 };
      anchors.reply_composer ??= { x: 0, y: height * 0.12, width, height: height * 0.78 };
      anchors.compose_editor ??= { x: width * 0.04, y: height * 0.14, width: width * 0.92, height: height * 0.62 };
    ...
    if (screen === "profile") {
      ...
      anchors.profile_banner ??= { x: 0, y: height * 0.12, width, height: height * 0.18 };
      anchors.profile_avatar ??= { x: width * 0.05, y: height * 0.24, width: width * 0.2, height: width * 0.2 };
      anchors.profile_tabs ??= { x: 0, y: height * 0.45, width, height: height * 0.06 };
    ...
    if (screen === "messages") {
      ...
      anchors.dm_row_0 ??= { x: width * 0.04, y: height * 0.16, width: width * 0.92, height: height * 0.09 };
      anchors.dm_row_0_avatar ??= { x: width * 0.04, y: height * 0.18, width: width * 0.11, height: width * 0.11 };
      anchors.dm_row_0_content ??= { x: width * 0.18, y: height * 0.18, width: width * 0.76, height: height * 0.06 };
      anchors.compose_fab ??= { x: width * 0.74, y: height * 0.79, width: width * 0.2, height: height * 0.14 };
    }
