...
export const ProfileScreen: React.FC<XScreenProps> = ({
  world,
  deviceId,
  width,
}) => {
  ...
  return (
    ...
    >
      <AppHeader
        ...
        onBack
        trailing={
          <IconButton icon="more" label="More profile actions" size={20} />
        }
      />
      <div style={{ flex: 1, minHeight: 0, overflow: "hidden" }}>
        ...
        >
          <section
            ...
            style={{ height: X_PROFILE_HEADER_HEIGHT, overflow: "hidden" }}
          >
            <div
              style={{
                height: 124,
            ...
            <div
              style={{ height: 68, paddingInline: 16, position: "relative" }}
            >
              <div
                style={{ position: "absolute", top: -40, insetInlineStart: 16 }}
              >
            ...
            <div style={{ padding: "0 16px 13px" }}>
              <div
                style={{
                  ...
                  alignItems: "center",
                  gap: 4,
                  fontFamily: experience.type.displayFamily,
                  fontSize: 22 * experience.type.scale,
                  lineHeight: 1.12,
                  fontWeight: 800,
                  letterSpacing: "-.025em",
                }}
              >
                <span>{user.name}</span>
                <VerifiedBadge variant={user.verified} size={18} />
              </div>
              <div
                style={{
                  marginTop: 2,
              ...
              >
                ...
                {user.joinedAt ? (
                  ...
                  >
                    <XIcon name="calendar" size={15} />
                    {experience.t("joined")}{" "}
                    {new Intl.DateTimeFormat(experience.locale, {
                      month: "long",
                      year: "numeric",
                      timeZone: "UTC",
              ...
              >
                <span>
                  <strong>
                    {formatXCount(user.following, experience.locale)}
                  </strong>{" "}
                ...
                <span>
                  <strong>
                    {formatXCount(user.followers, experience.locale)}
                  </strong>{" "}
                  <span style={{ color: experience.colors.textSecondary }}>
