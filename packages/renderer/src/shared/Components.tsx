...
function getTypography(platform: Platform) {
  if (platform === "ios") {
    return {
      footnote: iOSTokens.typography.footnote,
      body: iOSTokens.typography.body,
      caption2: iOSTokens.typography.caption2,
      headline: iOSTokens.typography.headline,
      caption1: iOSTokens.typography.caption1,
    };
  }
  return {
    footnote: androidTokens.typography.labelSmall,
    body: androidTokens.typography.bodyMedium,
    caption2: androidTokens.typography.labelSmall,
...
export const ChatBubble: React.FC<ChatBubbleProps> = ({
  ...
  const iosTokens = iOSTokens;
  const andTokens = androidTokens;
  const tokens = platform === "ios" ? iosTokens : andTokens;
  const defaultMyColor = "#E7FFDB";
  const defaultOtherColor = "#FFFFFF";
  ...
  const typography =
    platform === "ios"
      ...
      : {
          footnote: andTokens.typography.labelSmall,
          body: andTokens.typography.bodyMedium,
          caption2: andTokens.typography.labelSmall,
          headline: andTokens.typography.headlineSmall,
      ...
      >
        ...
        >
          {timestamp && (
            <span
              style={{
                ...getTypography(platform).caption2,
                fontFamily: tokens.fontFamily,
      ...
      >
        ...
        <div
          style={{
            display: "flex",
            flexDirection: "column",
            alignItems: avatarUrl || avatarEmoji ? "flex-start" : "center",
          }}
        >
          <span
            style={{
              ...getTypography(platform).headline,
              color: tokens.colors.label,
            }}
          >
            {title}
          ...
          {subtitle && (
            <span
              style={{
                ...getTypography(platform).caption1,
                color: tokens.colors.secondaryLabel,
              }}
            >
              {subtitle}
