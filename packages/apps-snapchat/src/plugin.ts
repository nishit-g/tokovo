...
import { SnapchatCinematicSubjects } from "./camera/subjects.js";
...
export const SnapchatPlugin: TokovoPluginContract<"app_snapchat"> & {
  ...
  cinematicSubjects: SnapchatCinematicSubjects,
  dsl: snapchatDsl,
...
export function registerSnapchatPlugin(
