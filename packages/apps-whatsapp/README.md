...
- semantic camera anchors for screens, messages, media, actions, and replies
...
- missing messages, conversations, anchors, plugins, and invalid lifecycle transitions fail loudly
