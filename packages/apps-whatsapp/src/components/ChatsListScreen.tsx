...
export const ChatsListScreen: React.FC<ChatsListScreenProps> = ({
  ...
  const config = getAppConfig("whatsapp", platform);
  ...
  >
    ...
    >
      ...
      <svg width="72" height="60" viewBox="0 0 24 20" fill="none">
        <path
          d="M4 5C2.9 5 2 5.9 2 7V17C2 18.1 2.9 19 4 19H20C21.1 19 22 18.1 22 17V7C22 5.9 21.1 5 20 5H17L15 2H9L7 5H4ZM12 15C9.8 15 8 13.2 8 11C8 8.8 9.8 7 12 7C14.2 7 16 8.8 16 11C16 13.2 14.2 15 12 15Z"
          fill="#007AFF"
        />
      </svg>
      {/* New chat icon */}
      <svg width="66" height="60" viewBox="0 0 22 20" fill="none">
        <path
          d="M21 1L1 8L9 11M21 1L14 19L9 11M21 1L9 11"
          stroke="#007AFF"
          strokeWidth="2"
          strokeLinecap="round"
