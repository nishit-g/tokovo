...
import { iosTheme } from "../theme/index.js";

const whatsappColors = {
  primary: iosTheme.colors.accent,
  textSecondary: iosTheme.colors.timestamp,
  readReceipt: iosTheme.colors.checkmarkRead,
  sentReceipt: iosTheme.colors.checkmark,
  tabInactive: iosTheme.colors.timestamp,
};
...
export const PhoneCallIcon = ({
  ...
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path
      d="M18.5 14.3V16.8C18.5 17.4 18.1 17.9 17.5 18C17.1 18 16.7 18 16.3 18C8.5 17.3 2.7 11.5 2 3.7C2 3.3 2 2.9 2 2.5C2.1 1.9 2.6 1.5 3.2 1.5H5.7C6.2 1.5 6.6 1.8 6.7 2.3C6.8 3 7 3.7 7.2 4.3C7.3 4.7 7.2 5.1 6.9 5.4L5.7 6.6C6.9 8.8 8.7 10.6 10.9 11.8L12.1 10.6C12.4 10.3 12.8 10.2 13.2 10.3C13.8 10.5 14.5 10.7 15.2 10.8C15.7 10.9 16 11.3 16 11.8V14.3H18.5Z"
      stroke={color}
      strokeWidth="1.6"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const PinIcon = ({
  ...
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    />
    <path
      d="M5 17H19L17 10V4C17 3.46957 16.7893 2.96086 16.4142 2.58579C16.0391 2.21071 15.5304 2 15 2H9C8.46957 2 7.96086 2.21071 7.58579 2.58579C7.21071 2.96086 7 3.46957 7 4V10L5 17Z"
      stroke={color}
      strokeWidth="1.8"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const LockIcon = ({
  ...
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    />
    <path
      d="M8 10V7.8C8 5.14903 10.149 3 12.8 3C15.451 3 17.6 5.14903 17.6 7.8V10"
      stroke={color}
      strokeWidth="1.8"
      strokeLinecap="round"
    />
...
export const MicrophoneFillIcon = ({
  ...
  <svg width="18" height="24" viewBox="0 0 22 30" fill={color}>
    ...
    <path
      d="M4 14V15C4 19.4 7.6 23 12 23C16.4 23 20 19.4 20 15V14"
      stroke={color}
      strokeWidth="2"
      strokeLinecap="round"
      fill="none"
...
export const CommunitiesIcon = ({
  ...
  <svg width="25" height="25" viewBox="0 0 25 25" fill="none">
    ...
    />
    <path
      d="M16 3.13C16.8604 3.35031 17.623 3.85071 18.1676 4.55232C18.7122 5.25392 19.01 6.11683 19.0101 7.005C19.0103 7.89318 18.7127 8.75618 18.1682 9.45788C17.6237 10.1596 16.861 10.6601 16 10.88"
      stroke={color}
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
