...
/**
 * Builder class for WhatsApp group operations.
 * Provides a fluent, chainable API for common group actions.
 */
export class GroupBuilder {
    private readonly conversationId: string;
    private readonly getFrame: () => number;
    private readonly pushOp: (op: any) => void;
...
/**
 * Factory function for creating a GroupBuilder.
 * Use this when you don't need the full class interface.
 */
