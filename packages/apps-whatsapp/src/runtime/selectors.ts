...
import type { WhatsAppConversation, WhatsAppState, WhatsAppMessage } from "../types";
 ...
 */
export function selectConversations(world: WorldState): Record<string, WhatsAppConversation> {
 ...
 */
export function selectCurrentConversationId(world: WorldState): string | undefined {
 ...
 */
export function selectCurrentConversation(world: WorldState): WhatsAppConversation | undefined {
