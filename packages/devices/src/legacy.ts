/**
 * Legacy device exports
 *
 * @deprecated Prefer device registries (use registerDevicesPlugin + registries).
 * These direct frame/shell exports bypass the scoped registry architecture.
 */
