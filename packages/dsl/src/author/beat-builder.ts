...
export interface AppScopedDsl {
  ...
  receive(
    ...
    opts: { from: string; text: string; messageId?: string },
  ): { messageId: string };
...
export class BeatBuilder {
   ...
   */
  edit(ref: MessageHandle, newText: string): this {
    const op: EditMessageOp = { kind: "EditMessage", ref, newText };
    this.ops.push(op);
    return this;
  }

  /**
   * Edit the last message's text.
   */
  editLast(newText: string): this {
    if (!this.lastMessageRef) {
      throw new Error("editLast() called but no previous message exists");
    }
    return this.edit(this.lastMessageRef, newText);
  }
  ...
  forwardLast(toConversationId: string, forwardedFrom?: string): this {
    if (!this.lastMessageRef) {
      throw new Error("forwardLast() called but no previous message exists");
    }
    return this.forward(this.lastMessageRef, toConversationId, forwardedFrom);
  }
  ...
  sendImage(
    url: string,
    options?: { caption?: string; height?: number; skipAutoTiming?: boolean },
  ): MessageHandle {
  ...
  sendGif(
    url: string,
    options?: { height?: number; skipAutoTiming?: boolean },
  ): MessageHandle {
  ...
  sendVoice(
    duration: number,
    options?: { skipAutoTiming?: boolean },
  ): MessageHandle {
  ...
  playVoice(ref?: MessageHandle, startAt?: number): this {
    const op: PlayVoiceOp = { kind: "PlayVoice", ref, startAt };
    this.ops.push(op);
    return this;
  }

  pauseVoice(ref?: MessageHandle): this {
    const op: PauseVoiceOp = { kind: "PauseVoice", ref };
    this.ops.push(op);
    return this;
  }
  ...
  pinConversation(conversationId?: string): this {
    const op: PinConversationOp = {
      kind: "PinConversation",
  ...
  unpinConversation(conversationId?: string): this {
    const op: UnpinConversationOp = {
      kind: "UnpinConversation",
      conversationId: conversationId ?? this.conversationId,
    };
    this.ops.push(op);
    return this;
  ...
  muteConversation(conversationId?: string, until?: number): this {
    const op: MuteConversationOp = {
      kind: "MuteConversation",
      conversationId: conversationId ?? this.conversationId,
      until,
    };
    this.ops.push(op);
  ...
  unmuteConversation(conversationId?: string): this {
    const op: UnmuteConversationOp = {
      kind: "UnmuteConversation",
      conversationId: conversationId ?? this.conversationId,
    };
    this.ops.push(op);
    return this;
  ...
  archiveConversation(conversationId?: string): this {
    const op: ArchiveConversationOp = {
  ...
  unarchiveConversation(conversationId?: string): this {
    const op: UnarchiveConversationOp = {
      kind: "UnarchiveConversation",
      conversationId: conversationId ?? this.conversationId,
    };
    this.ops.push(op);
    return this;
  ...
  tweetReceived(
    ...
    this.ops.push({
      ...
      meta: {
        ...
        author,
        ...(options?.media && { media: options.media }),
        ...(options?.replyCount !== undefined && {
          replyCount: options.replyCount,
        }),
        ...(options?.retweetCount !== undefined && {
          retweetCount: options.retweetCount,
        }),
        ...(options?.likeCount !== undefined && {
  ...
  simulateTyping(
    ...
    const framesPerChar =
      options?.framesPerChar || Math.round(60 / charsPerSecond);
  ...
  private generateTypingSequence(
    ...
    while (
      typoPositions.size < Math.min(typoCount, Math.floor(text.length / 3))
    ) {
