...
export const audio = {
  ...
  whatsappReceived(options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("whatsapp_received", {
      bus: "ui",
      volume: 0.9,
      ...options,
    });
  ...
  whatsappSent(options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("whatsapp_sent", {
      bus: "ui",
      volume: 0.7,
      ...options,
    });
  ...
  notification(options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("notification", {
      bus: "ui",
      volume: 1.0,
      ...options,
    });
  ...
  tenseMood(options: Partial<BackgroundMusicOptions> = {}) {
    return audio.backgroundMusic("suspense", {
      volume: 0.25,
      mood: "tense",
      ...options,
    });
  ...
  dramaticMood(options: Partial<BackgroundMusicOptions> = {}) {
    return audio.backgroundMusic("dramatic", {
      volume: 0.3,
      mood: "dramatic",
      ...options,
    });
  ...
  callRingtone(callId: string, options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("app_whatsapp.call_ringtone", {
      bus: "ui",
      volume: 1.0,
      loop: true,
      instanceId: `call_ring_${callId}`,
      ...options,
    });
  },

  callOutgoing(callId: string, options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("app_whatsapp.call_outgoing", {
      bus: "ui",
      volume: 0.8,
      loop: true,
      instanceId: `call_out_${callId}`,
      ...options,
    });
  },

  callEnd(options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("app_whatsapp.call_end", {
      bus: "ui",
      volume: 0.7,
      ...options,
    });
  ...
  stopCallRingtone(callId: string) {
    return audio.stopSound(`call_ring_${callId}`);
  },

  stopCallOutgoing(callId: string) {
    return audio.stopSound(`call_out_${callId}`);
  },

  pttStart(options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("app_whatsapp.ptt_start", {
      bus: "ui",
      volume: 0.6,
      ...options,
    });
  ...
  pttSend(options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("app_whatsapp.ptt_send", {
      bus: "ui",
      volume: 0.7,
      ...options,
    });
  ...
  pttCancel(options: Partial<PlaySoundOptions> = {}) {
    return audio.playSound("app_whatsapp.ptt_cancel", {
      bus: "ui",
      volume: 0.5,
      ...options,
    });
