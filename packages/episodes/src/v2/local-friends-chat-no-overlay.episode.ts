  ...
  build: () =>
    episode("v2-local-friends-chat-no-overlay", { fps: 30, duration: "44s" })
      .device("phone", "iphone16", {
        ...
        os: { time: new Date("2025-06-26T21:41:00Z"), battery: 54, network: "5G" },
      })
      ...
      .notificationTrack("phone", (notifications) => {
        notifications.at("7.2s").deliver({
          id: "x_tag",
          appId: "app_x",
          content: { title: "X", body: "Your teaser thread is live." },
          category: "social",
          interruption: "timeSensitive",
          privacy: "public",
          threadId: "teaser-thread",
        });
      })
      ...
      .camera((cam) => {
        ...
        cam.at("7.25s").focus("notification.banner", { scale: 1.18, duration: "0.45s" });
