  ...
  build: () =>
    episode("v2-device-baseline", { fps: 30, duration: "24s" })
      .device("phone", "iphone16", {
        ...
        os: { time: new Date("2025-06-26T09:41:00"), battery: 81, network: "5G" },
      })
      ...
      .deviceTrack("phone", (d) => {
        ...
        d.at("2.6s").unlock();
        d.at("3.4s").openApp("app_whatsapp", { transition: { durationFrames: 18, style: "iosZoom" } });
      })
      ...
      .deviceTrack("phone", (d) => {
        d.at("11.2s").openApp("app_x", { transition: { durationFrames: 18, style: "iosZoom" } });
      })
      .x("phone", (x) => {
        x.seed({
          users: [
            { id: "u_me", name: "Me", handle: "me", followers: 2100, following: 120, verified: null },
            { id: "u_him", name: "Him", handle: "him", followers: 54000, following: 500, verified: "blue" },
          ],
          tweets: [
            { id: "tw_1", authorId: "u_him", text: "Receipts at 10.", viewCount: 84000, shareCount: 1400, bookmarkCount: 5200 },
          ],
        });
      ...
      .camera((cam) => {
        ...
        cam.at("0.7s").animate({ scale: 1.08, duration: "0.35s", easing: "easeOut" });
        cam.span("4.2s", "10.0s").trackCinematic("lastMessage", { scale: 1.14, smoothing: 0.18 });
        cam.at("12.05s").focus("tweet_card", { scale: 1.1, duration: "0.4s" });
        cam.span("12.4s", "15.2s").trackCinematic("tweet_card", { scale: 1.12, smoothing: 0.16 });
      })
      .build(),
});
