  ...
  build: () =>
    episode("v2-overlay-baseline", { fps: 30, duration: "30s" })
      .device("phone", "iphone16", {
        ...
        os: {
          time: new Date("2025-06-26T21:12:00Z"),
          battery: 54,
          network: "5G",
        },
      })
      ...
      .overlay((ov) => {
        ov.at("0.0s").hook("He posted the screenshot.", {
          durationFrames: 120,
          intensity: 0.9,
        });
        ov.at("3.8s").caption("Watch the group chat turn into a courtroom.", {
          durationFrames: 150,
        });
        ov.at("8.6s").receipt("Exhibit A: 'I never lie, I remix the truth.'", {
          preset: "topLeft",
          durationFrames: 180,
        });
        ov.at("16.2s").caption("This is where the details land.", {
          durationFrames: 120,
        });
        ov.at("22.8s").cliffhanger("Wait for the last message.", {
          durationFrames: 180,
          intensity: 1.0,
        });
      })
