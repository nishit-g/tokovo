...
export default defineEpisode({
  ...
  build: () => {
    const baseTs = new Date("2026-04-10T09:20:00Z").getTime();
    ...
    return episode("linkedin-flagship-v2", {
      ...
      .device("phone", "iphone16", {
        app: "app_linkedin",
        os: {
          time: new Date("2026-04-10T09:22:00Z"),
          battery: 87,
          network: "5G",
        },
      })
        ...
        users: [
          {
            ...
            name: "Ira Sen",
            handle: "irasen",
            headline: "Design systems + story-first products",
          ...
          },
          {
            ...
            name: "Mina Park",
            handle: "minapark",
            headline: "Brand storyteller and launch strategist",
        ...
        posts: [
          {
            id: "li_flag_1",
            authorId: "u1",
            text: "We shipped the quiet version of our homepage and the conversion rate moved before the design Twitter people even noticed.",
          ...
          },
          {
            id: "li_flag_2",
            authorId: "me",
            text: "Good product cameras are not decoration. They are readability infrastructure.",
        ...
        notifications: [
          {
            ...
            postId: "li_flag_2",
            unread: true,
            createdAt: baseTs - 40000,
            title: "Mina Park liked your post",
            body: "Good product cameras are not decoration...",
          },
        ],
        threads: [
          {
        ...
        messages: [
          {
            ...
            threadId: "li_dm_1",
            senderId: "u1",
            text: "Can you review the hiring post before I send it live?",
