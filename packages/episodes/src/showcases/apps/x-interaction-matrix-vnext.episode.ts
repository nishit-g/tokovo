  ...
  build: () =>
    episode("x-interaction-matrix-vnext", {
          ...
          tweets: [
            {
              ...
              linkPreview: {
                ...
                description:
                  "The rendering and authoring changes behind the new release.",
          ...
          notifications: [
            {
              ...
              type: "verified",
              actorId: "ios_author",
              createdAt: baseTime - 22_000,
            },
          ],
          threads: [
            {
              id: "ios_dm",
              participantIds: ["ios_me", "ios_author"],
              pinned: true,
            },
          ],
          messages: [
      ...
      .view(
        "app_x",
        "ios_light",
        { schemaVersion: 2, screen: "timeline" },
        { version: 2 },
      )
      .snapshot(
        "app_x",
        "android_ar",
        {
          ...
          threads: [
            {
              id: "ar_dm",
              participantIds: ["ar_me", "ar_author"],
              unreadCount: 2,
            },
          ],
          messages: [
      ...
      .x("ios_light", (x) => {
        ...
        x.at("12s").sendMessage(
          ...
          {
            input: { duration: "2s", style: "fast", id: "x-ios-dm-input" },
          },
        );
      ...
      .x("android_ar", (x) => {
        ...
        x.at("13s").startTyping("ar_dm", "ar_author");
        x.at("14.8s").stopTyping("ar_dm", "ar_author");
