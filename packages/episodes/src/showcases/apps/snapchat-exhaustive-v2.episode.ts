...
export default defineEpisode({
  ...
  build: () =>
    episode("snapchat-exhaustive-v2", {
      ...
      .snapchat("phone", "conv_bestie_v2", (sc) => {
        sc.at("0s").createConversation({
          id: "conv_bestie_v2",
          title: "Bestie",
          participants: [{ id: "bestie", name: "Bestie" }],
          streak: 512,
        });
        sc.at("0.2s").createConversation({
          id: "conv_room_v2",
          title: "afterparty",
          participants: [
        ...
        sc.at("0.4s").createConversation({
          id: "conv_crush_v2",
          title: "Ari",
          participants: [{ id: "ari", name: "Ari" }],
          streak: 22,
        });
        sc.at("1.0s").openConversation("conv_bestie_v2");
        sc.at("2.0s").receive(
          "Bestie",
          "you cannot freak out when you see this",
        );
        ...
        sc.at("19.4s").receive(
          "Ari",
          "why is the group louder than my notifications",
        );
