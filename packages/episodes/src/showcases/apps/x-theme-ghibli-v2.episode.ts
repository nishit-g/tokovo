...
export default defineEpisode({
  meta: {
    id: "x-theme-ghibli-v2",
    title: "X Theme Ghibli V2",
    description:
      "A brand-new Ghibli-themed X showcase proving the softer theme pass across timeline, notifications, and DMs.",
    category: "showcase",
    ...
    visibility: "public",
    sortOrder: 220,
    tags: ["x", "theme", "ghibli", "timeline", "soft"],
  },
  config: {
    format: "1080x1920",
  ...
  build: () => {
    ...
    return episode("x-theme-ghibli-v2", {
      fps: 30,
      duration: "27s",
      title: "X Theme Ghibli V2",
    })
      ...
      .snapshot("app_x", "phone", {
        ...
        threads: [{ id: "dm_ghibli_v2", participantIds: ["u_mira", "u_elm"] }],
        messages: [
          { id: "msg_ghibli_v2_1", threadId: "dm_ghibli_v2", senderId: "u_elm", text: "The hillside draft finally feels alive.", createdAt: baseTs - 20000 },
        ],
      })
      .x("phone", (x) => {
        x.at("0.8s").setThemeMode("ghibli");
        x.at("1.2s").navigate("timeline");
        x.at("3.0s").navigate("tweet", { tweetId: "tw_ghibli_v2_1" });
        x.at("5.0s").replyTweet({
          id: "tw_ghibli_v2_reply",
          authorId: "u_elm",
          replyToId: "tw_ghibli_v2_1",
        ...
        x.at("8.8s").addNotification({
          ...
          type: "reply",
          actorId: "u_elm",
          tweetId: "tw_ghibli_v2_1",
        });
        x.at("9.6s").navigate("notifications");
        x.at("12.0s").navigate("messages");
        x.at("13.0s").navigate("thread", { threadId: "dm_ghibli_v2" });
        x.at("15.0s").sendMessage({
          id: "msg_ghibli_v2_2",
          threadId: "dm_ghibli_v2",
          senderId: "u_mira",
