  ...
  build: () => {
    ...
    return episode("instagram-theme-storybook-v2", {
      ...
      .snapshot("app_instagram", "phone", {
        ...
        users: [
          {
            ...
            bio: "Quiet sets and impossible skies.",
        ...
        threads: [
          {
            id: "ig_storybook_thread",
            participantIds: ["ig_mira", "ig_elm"],
            title: "Elm Storyboard",
            unreadCount: 1,
          },
        ],
        messages: [
          {
            id: "ig_storybook_msg_1",
            threadId: "ig_storybook_thread",
            senderId: "ig_elm",
            text: "The second story frame finally feels like wind, not blur.",
