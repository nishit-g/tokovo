  ...
  build: () =>
    episode("whatsapp-theme-storybook-v2", {
      ...
      .snapshot("app_whatsapp", "phone", {
        ...
        statuses: [
          ...
          },
          {
            ...
            media: {
              type: "text",
              text: "The grass can breathe now.",
              backgroundColor: "#607A63",
            },
          },
          {
            id: "elm_status_3",
        ...
        settings: {
          ...
          chats: {
            theme: "light",
            backupLabel: "Today, 9:50 PM",
            defaultDisappearingMessages: "24 hours",
          },
          notifications: {
            messageTone: "Bamboo",
            groupTone: "Night birds",
            mutedChats: 1,
          },
          storage: {
            usedLabel: "1.9 GB used",
      ...
      .whatsapp("phone", "dm_elm_v2", (wa) => {
        ...
        wa.at("3.0s").receive(
          "Elm",
          "The sky finally stopped looking artificial.",
        );
        wa.at("5.0s").send(
          "Good. Let the grass breathe and don't sharpen the clouds.",
          {},
        );
        wa.openUpdates("8.8s");
        ...
        wa.at("15.6s").receive(
          "Ren",
          "Moonlit cut exported. It's absurdly pretty.",
        );
