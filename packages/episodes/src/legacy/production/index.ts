...
import entityCommandCenter from "./entity-command-center.episode.js";
...
import ghibliWhatsappXCrossover from "./ghibli-whatsapp-x-crossover.episode.js";
...
import multilayerShowcase from "./multilayer-showcase.episode.js";
...
import teamsExecEscalation from "./teams-exec-escalation.episode.js";
...
import typingPlugin from "./typing-plugin.episode.js";
...
export const productionEpisodes: EpisodeDefinition[] = [
  markLegacyEpisode(attendanceHeistBros),
  markLegacyEpisode(bakchodiBros),
  markLegacyEpisode(birthdayCoverupChaos),
  markLegacyEpisode(cameraShowcase),
  markLegacyEpisode(cheatingExposedNewDx),
  markLegacyEpisode(cheatingExposed),
  markLegacyEpisode(cyberpunkShowcase),
  markLegacyEpisode(entityCommandCenter),
  markLegacyEpisode(featureShowcase),
  markLegacyEpisode(flirtyWhatsappRomance),
  markLegacyEpisode(ghibliWhatsappXCrossover),
  markLegacyEpisode(ghibliShowcase),
  markLegacyEpisode(imessageAnchorTour),
  markLegacyEpisode(instagramCreatorDrop),
  markLegacyEpisode(instagramReelRoast),
  markLegacyEpisode(integrationTest),
  markLegacyEpisode(keyboardDemo),
  markLegacyEpisode(launchLeakNightmare),
  markLegacyEpisode(megaLinkedin),
  markLegacyEpisode(megaMegaWhatsapp),
  markLegacyEpisode(megaV2EpisodeWhatsapp),
  markLegacyEpisode(megaWhatsapp),
  markLegacyEpisode(megaX),
  markLegacyEpisode(midnightMaggiCrisis),
  markLegacyEpisode(mrrobotTheHook),
  markLegacyEpisode(multilayerShowcase),
  markLegacyEpisode(notificationDemo),
  markLegacyEpisode(profileFocusDemo),
  markLegacyEpisode(snapchatBestieDrama),
  markLegacyEpisode(teamsExecEscalation),
  markLegacyEpisode(teamsWarRoom),
  markLegacyEpisode(trackDemo),
  markLegacyEpisode(typedMessageDemo),
  markLegacyEpisode(typewriterLetter),
  markLegacyEpisode(typingPlugin),
  markLegacyEpisode(voiceDemo),
  markLegacyEpisode(whatsappGhibli),
  markLegacyEpisode(whatsappToXViral),
  markLegacyEpisode(whatsappToX),
  markLegacyEpisode(whatsappV1Flagship),
  markLegacyEpisode(whtEpi),
  markLegacyEpisode(xAnchorTour),
];
