 ...
 */
export function isRuntimeDeviceEvent(event: RuntimeEvent): event is DeviceRuntimeEvent {
 ...
 */
export function isRuntimeCameraEvent(event: RuntimeEvent): event is CameraRuntimeEvent {
 ...
 */
export function isRuntimeAudioEvent(event: RuntimeEvent): event is AudioRuntimeEvent {
 ...
 */
export function isRuntimeKeyboardEvent(event: RuntimeEvent): event is KeyboardRuntimeEvent {
