...
describe("engine handlers", () => {
  it("processes audio events", () => {
    ...
    processAudioEvent(
      ...
      { frame: 1, eventIndex: 0, mode: "preview", fps: 30 },
    );
    ...
    processAudioEvent(
      ...
      { frame: 2, eventIndex: 0, mode: "preview", fps: 30 },
    );
    ...
    processAudioEvent(
      ...
      { frame: 3, eventIndex: 0, mode: "preview", fps: 30 },
    );
    ...
    processAudioEvent(
      ...
      { frame: 4, eventIndex: 0, mode: "preview", fps: 30 },
    );
    ...
    processAudioEvent(
      ...
      { frame: 5, eventIndex: 0, mode: "preview", fps: 30 },
    );
    ...
    processAudioEvent(
      ...
      { frame: 6, eventIndex: 0, mode: "preview", fps: 30 },
    );
    ...
    processAudioEvent(
      ...
      { frame: 7, eventIndex: 0, mode: "preview", fps: 30 },
    );
    ...
    processAudioEvent(
      ...
      { frame: 8, eventIndex: 0, mode: "preview", fps: 30 },
    );
    expect(Object.keys(world.audio.activeSounds)).toHaveLength(0);
  });
  ...
  it("uses default fade and crossfade durations", () => {
    ...
    processAudioEvent(
      world,
      { kind: "AUDIO", type: "FADE_OUT", at: 5 } as any,
      ctx,
    );
  ...
  it("clamps fade duration and stops sounds by bus", () => {
    ...
    processAudioEvent(
      ...
      { frame: 10, eventIndex: 0, mode: "preview", fps: 30 },
    );
  ...
  it("applies auto sound instructions", () => {
    ...
    handleAutoSounds(
      world,
      { kind: "APP", type: "MESSAGE_RECEIVED", appId: "app", at: 1 } as any,
      {
        frame: 1,
        eventIndex: 0,
        mode: "preview",
    ...
    const spy = vi
      ...
      .mockReturnValue([{ action: "STOP_SOUND", soundId: "ding" } as any]);

    handleAutoSounds(
      world,
      { kind: "APP", type: "MESSAGE_RECEIVED", appId: "app", at: 2 } as any,
      {
        frame: 2,
        eventIndex: 0,
        mode: "preview",
  ...
  it("processes call events", () => {
    ...
    processCallEvent(
      world,
      { kind: "CALL", type: "INCOMING", deviceId: "phone", at: 1 } as any,
      {
        frame: 1,
        eventIndex: 0,
        mode: "preview",
    ...
    processCallEvent(
      world,
      { kind: "CALL", type: "ANSWER", deviceId: "phone", at: 2 } as any,
      {
        frame: 2,
        eventIndex: 0,
        mode: "preview",
    ...
    processCallEvent(
      world,
      { kind: "CALL", type: "TOGGLE_MUTE", deviceId: "phone", at: 3 } as any,
      {
        frame: 3,
        eventIndex: 0,
        mode: "preview",
    ...
    processCallEvent(
      world,
      { kind: "CALL", type: "TOGGLE_SPEAKER", deviceId: "phone", at: 3 } as any,
      {
        frame: 3,
        eventIndex: 0,
        mode: "preview",
    ...
    processCallEvent(
      world,
      { kind: "CALL", type: "TOGGLE_HOLD", deviceId: "phone", at: 3 } as any,
      {
        frame: 3,
        eventIndex: 0,
        mode: "preview",
    ...
    processCallEvent(
      world,
      { kind: "CALL", type: "DECLINE", deviceId: "phone", at: 3 } as any,
      {
        frame: 3,
        eventIndex: 0,
        mode: "preview",
    ...
    processCallEvent(
      world,
      { kind: "CALL", type: "END", deviceId: "phone", at: 4 } as any,
      {
        frame: 4,
        eventIndex: 0,
        mode: "preview",
    ...
    processCallEvent(
      emptyWorld,
      { kind: "CALL", type: "INCOMING", at: 1 } as any,
      {
        frame: 1,
        eventIndex: 0,
        mode: "preview",
  ...
  it("processes OS events and normalizes network", () => {
    ...
    processOSEvent(
      world,
      { kind: "OS", type: "SET_TIME", deviceId: "phone", at: 1 } as any,
      {
        frame: 1,
        eventIndex: 0,
        mode: "preview",
    ...
    processOSEvent(
      world,
      { kind: "OS", type: "SET_BATTERY", deviceId: "phone", at: 2 } as any,
      {
        frame: 2,
        eventIndex: 0,
        mode: "preview",
    ...
    processOSEvent(
      world,
      { kind: "OS", type: "DRAIN_BATTERY", deviceId: "phone", at: 3 } as any,
      {
        frame: 3,
        eventIndex: 0,
        mode: "preview",
    ...
    processOSEvent(
      world,
      { kind: "OS", type: "SET_NETWORK", deviceId: "phone", at: 4 } as any,
      {
        frame: 4,
        eventIndex: 0,
        mode: "preview",
    ...
    processOSEvent(
      world,
      { kind: "OS", type: "SET_DND", deviceId: "phone", at: 5 } as any,
      {
        frame: 5,
        eventIndex: 0,
        mode: "preview",
    ...
    processOSEvent(
      world,
      { kind: "OS", type: "SET_LOW_POWER", deviceId: "phone", at: 6 } as any,
      {
        frame: 6,
        eventIndex: 0,
        mode: "preview",
