...
export const PresetBackground: React.FC<{
  ...
  frame?: number;
  fps?: number;
}> = ({ preset, frame, fps }) => <BackgroundLayer config={preset} frame={frame} fps={fps} />;
...
export const ImageBackground: React.FC<{
  ...
  <BackgroundLayer config={{ type: "image", src, opacity, blur }} frame={frame} fps={fps} />
);
...
export const VideoBackground: React.FC<{
  ...
  <BackgroundLayer config={{ type: "video", src, opacity, blur }} frame={frame} fps={fps} />
);
