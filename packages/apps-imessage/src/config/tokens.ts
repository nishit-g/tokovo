...
export const iMessageSpacing = {
  ...
  // App-owned horizontal spacing; vertical insets come from AppViewportFrame.
  screenPaddingH: 16,
...
export const iMessageLayout = {
  ...
  // Computed heights
  getChatAreaHeight: (screenHeight: number, contentTop: number, contentBottom: number) =>
    screenHeight -
    iMessageSpacing.headerHeight -
    iMessageSpacing.inputHeight -
    contentTop -
    contentBottom,
} as const;
